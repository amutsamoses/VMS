...
export const bookingEnum = pgEnum("booking_status", [
  "Pending",
  "Confirmed",
  "Cancelled",
  "Completed",
]);
export const payMentEnum = pgEnum("payment_status", [
  "Pending",
  "Completed",
  "Refunded",
]);
...
export const Vehicles = pgTable("vehicles", {
  ...
  vehicleSpec_id: integer("vehicleSpec_id").references(
...
export const Bookings = pgTable("bookings", {
  ...
  location_id: integer("location_id").references(
    () => LocationsAndBranches.location_id,
    { onDelete: "cascade" }
  ),
...
export const vehicleSpecRelations = relations(
  VehicleSpecifications,
  ({ one, many }) => ({
    vehicles: many(Vehicles),
    fleet: one(FleetManagement, {
      fields: [VehicleSpecifications.vehicleSpec_id],
...
export const customerSupportRelations = relations(
